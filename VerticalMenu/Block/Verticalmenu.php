            ...
            foreach($children as $child) {
                ...
                if (!$vc_menu_hide_item) {
                    ...
                    if($level == 1 && $vc_menu_icon_img) {
                        $html .= '<div class="menu-thumb-img"><a class="menu-thumb-link" href="'.$this->_categoryHelper->getCategoryUrl($child).'"><img src="' . $this->_helper->getBaseUrl().'catalog/category/verticalmenu/' . $vc_menu_icon_img . '" alt="'.$child->getName().'"/></a></div>';
                    }
                    $html .= '<a'.$a_class.' href="'.$this->_categoryHelper->getCategoryUrl($child).'">';
                    if ($level > 1 && $vc_menu_icon_img)
                        $html .= '<img class="menu-thumb-icon" src="' . $this->_helper->getBaseUrl().'catalog/category/verticalmenu/' . $vc_menu_icon_img . '" alt="'.$child->getName().'"/>';
            ...
            if(!$vc_menu_hide_item) {
                ...
                if($cat_model->getData('vertcial_menu_bg_img') != ''){
                    ...
                    if(is_array($trim_pub) && count($trim_pub) > 0){
                        ...
                        $url_fixed = $mediaUrl.'catalog/category/verticalmenu/'.$path_media;
                    }
